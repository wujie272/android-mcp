...
加载策略:
  🚀 第1层：核心工具  立即加载  → device_info, ui_automation, aggregation, prompts
...
import android_mcp.tools.aggregation       # noqa: F401 聚合工具（device_health/analyze_app/quick_status）
import android_mcp.prompts                 # noqa: F401 MCP Prompt 模板（工作流模板）
import android_mcp.resources               # noqa: F401 MCP Resources（设备数据源）
